...
namespace ArientMusicPlayer {
	public class FileManager {
		...
		static string playlistFolderPath = "\\Playlists\\";
		public static string localLibPath = "\\Library\\";
		public static string localLibDataPath = "\\Library\\.data";
		public static string serverLibPath = "Z:\\TestSync\\";
		public static string serverLibDataPath = "Z:\\TestSync\\.data";

		public static void SetFolderPaths() {
			playlistFolderPath = Directory.GetCurrentDirectory() + playlistFolderPath;
			localLibPath = Directory.GetCurrentDirectory() + localLibPath;
			localLibDataPath = Directory.GetCurrentDirectory() + localLibDataPath;
		}
		...
		#region Parsing and Saving of libraryPlaylist into .data

		void SaveLibraryToDisk(ref Playlist playlist, string savePath) {
			

		}

		void LoadLibraryFromDisk(ref Playlist playlist, string dataPath) { 
